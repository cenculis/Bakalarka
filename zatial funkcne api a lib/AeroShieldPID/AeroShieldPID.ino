...
int T=100;                    // Section length in ms
float R[]={45.0,23.0,75.0,32.0,10.0,19.0,35.0,29.0,5.0,43.0,65.0,15.0};   // Reference trajectory
float r=0.0;                  // Reference (Wanted pendulum angle)
float y = 0.0;                // Output (Current pendulum angle)
float u = 0.0;                // Input (motor power)

  #define KP 3.377           // PID Kp constant
  #define TI 3.121           // PID Ti constant
  #define TD 0.23            // PID Td constant
