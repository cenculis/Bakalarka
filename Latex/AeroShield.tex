...
\begin{figure}
	\hfill
	\subfigure[Model tvorený v programe CATIA.]{\includegraphics[width=75mm]{obr/spojeneKyvadlo.png}}
	\hfill
	\subfigure[Zostavený model AeroShieldu.]{\includegraphics[width=65mm]{obr/BezPozadnia.png}}
	\hfill
