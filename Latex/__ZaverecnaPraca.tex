...
\renewcommand\lstlistingname{Zoznam zdrojových kódov}
...
\cleardoublepage
% \phantomsection
\addcontentsline{toc}{chapter}{Zdrojový kód AeroShield.h}
\include{Zdrojovy kod headeru}
\addcontentsline{toc}{chapter}{Zdrojový kód AeroShield.cpp}
\include{Zdrojovy kod sourcu}
\end{document}
