...
void AeroClass::begin(void) {                                      // Board initialisation
  AutomationShield.serialPrint("AeroShield initialisation...");
  ...
  _wasCalibrated = false;
    ...
    while(1){
        if(ams5600.detectMagnet() == 1 ){
            AutomationShield.serialPrint("Current Magnitude: ");
            AutomationShield.serialPrint(ams5600.getMagnitude());
...
AeroClass AeroShield;                                   // Creation of FloatClass object
